...
class BinanceNeutralStrategy_REG_RCCD_VIDYA_RWI_APZ(NeutralStrategyBase):
    # 2. ('reg', False, 8, 1.0), ('rccd', 1, 6, 0.6), ('vidya', True, 12, 0.1), ('rwih', True, 96, 0.1), ('rwil', True, 48, 0.3), ('apz', True, 9, 0.1)
...
class BinanceNeutralStrategy_V1UP_REG_PMO(NeutralStrategyBase):
    # 3. ('v1_up', True, 9, 0.5, 1), ('reg', False, 24, 0.7, 1), ('pmo', True, 3, 0, 1)
